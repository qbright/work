...
public class MailServerApplication extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        blocker.getBlockedAddresses().add("123456");
        blocker.setNext(tracer);
        Router router = new Router(getContext());
        
        router.attach("http://localhost:8111/", tracer);
        router.attach("http://localhost:8111/accountId/", blocker);
        router.attach("http://localhost:8111/accounrId/{accountId}", blocker);
