 ...
 * @model
 */
public class LongArrayParser implements Parser<long[]> {
    ...
    public long[] parse(String value) throws ParseException {
        if (value == null || value.length() == 0)
            return new long[0];
        return cast(new ArrayParser<Long>(Long.class).parse(value));
    }
    ...
    public long[] cast(Object value) {
        ...
        Long[] temp = new ArrayParser<Long>(Long.class).cast(value);
